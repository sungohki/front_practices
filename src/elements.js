...
const aboutBox = mainSection.querySelector('.aboutBox');
const featuresBox = mainSection.querySelector('.featuresBox');
...
const featureCards = featuresBox.querySelectorAll('.stack > .item');
